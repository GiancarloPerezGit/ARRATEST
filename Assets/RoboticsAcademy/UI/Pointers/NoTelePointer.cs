...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public class NoTelePointer : CurvePointer
    {
        [SerializeField]
        ...
        public MixedRealityInputAction teleportAction = MixedRealityInputAction.None;

        public MixedRealityInputAction stopAction = MixedRealityInputAction.None;
